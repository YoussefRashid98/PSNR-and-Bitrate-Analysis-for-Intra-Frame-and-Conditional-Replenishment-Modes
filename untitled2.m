Q=2^4;    
Yuv = yuv_import_y('foreman_qcif.yuv',[176 144],50);

    size_coefficient_block = [176 144]/16;
    coefficient_block = zeros(size_coefficient_block(1), ...
        size_coefficient_block(2), 16, 16, 50); 
    ...
    for frame = 1:50
        ...
        R(frame) = p3s2_bitrate(coefficient_block(:,:,:,:,frame));
    end
